...
class Attn_discriminator(tf.keras.Model):
  def __init__(self):
    ...
    self.middle_list_0 = [
      discriminator_Middle(kernel_size=3, filters=256, strides=2, padding='same', name='h0_middle1'),#1024*4*4
      discriminator_Middle(kernel_size=3, filters=128, strides=2, padding='same', name='h0_middle2'),#512*8*8
      discriminator_Middle(kernel_size=3, filters=64, strides=2, padding='same', name='h0_middle3'),#256*16*16
    ]
    ...
    self.middle_list_1 = [
      discriminator_Middle(kernel_size=3, filters=256, strides=2, padding='same', name='h1_middle1'),  # 1024*4*4
      discriminator_Middle(kernel_size=3, filters=128, strides=2, padding='same', name='h1_middle2'),  # 512*8*8
      discriminator_Middle(kernel_size=3, filters=64, strides=2, padding='same', name='h1_middle3'),  # 256*16*16
    ]
  ...
  def call(self, text_embedding, image_0, image_1):
    ...
    x1 = self.input_layer_0(image_1)
    for i in range(len(self.middle_list_0)):
      x1 = self.middle_list_0[i](x1)
